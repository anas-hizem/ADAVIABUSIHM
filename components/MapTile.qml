...
Item {
    ...
    ColumnLayout {
            ...
            ColumnLayout{
                ...
                Rectangle {
                    ...
                    Image{
                        ...
                        anchors.centerIn: parent
                        source: "qrc:/assets/map/plus.png"
                        MouseArea {
                            anchors.fill: parent
                            onClicked: {
                                geomapview.zoomIn()
                ...
                Rectangle {
                    ...
                    Image{
                        width: parent.width * 0.5
                        height: parent.height * 0.5
                        source: "qrc:/assets/map/moins.png"
                        anchors.centerIn: parent
                        MouseArea {
                            anchors.fill: parent
                            onClicked: {
        ...
        Rectangle {
            ...
            color: "#FFFFFF"
            Image {
                source: "qrc:/assets/map/navigation.png"
                width: parent.width * 0.5
                height: parent.height * 0.5
        ...
        Rectangle {
            ...
            Image {
                id: location
                source: "qrc:/assets/map/location.png"
                width: parent.width * 0.5
                height: parent.height * 0.5
                fillMode: Image.PreserveAspectFit
                MouseArea {
        ...
        Rectangle {
            ...
            Image {
                id: path
                source: "qrc:/assets/map/path.png"
                width: parent.width * 0.5
                height: parent.height * 0.5
                fillMode: Image.PreserveAspectFit
                MouseArea {
