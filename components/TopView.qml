    ...
    Repeater {
        ...
        Item {
            ...
            Image {
                ...
                property var waveImages: ["qrc:/assets/ultrason/green-wave-01.png", "qrc:/assets/ultrason/green-wave-02.png", "qrc:/assets/ultrason/green-wave-03.png", "qrc:/assets/ultrason/green-wave-04.png", "qrc:/assets/ultrason/green-wave-05.png"]
                ...
                function updateAppearance(distance) {
                    if (distance < 1) {
                        waveImage.waveImages = ["qrc:/assets/ultrason/red-wave-01.png", "qrc:/assets/ultrason/red-wave-02.png", "qrc:/assets/ultrason/red-wave-03.png", "qrc:/assets/ultrason/red-wave-04.png", "qrc:/assets/ultrason/red-wave-05.png"];
                        waveImage.interval = 100;
                    } else if (distance >= 1 && distance <= 2) {
                        waveImage.waveImages = ["qrc:/assets/ultrason/orange-wave-01.png", "qrc:/assets/ultrason/orange-wave-02.png", "qrc:/assets/ultrason/orange-wave-03.png", "qrc:/assets/ultrason/orange-wave-04.png", "qrc:/assets/ultrason/orange-wave-05.png"];
                        waveImage.interval = 200;
                    } else {
                        waveImage.waveImages = ["qrc:/assets/ultrason/green-wave-01.png", "qrc:/assets/ultrason/green-wave-02.png", "qrc:/assets/ultrason/green-wave-03.png", "qrc:/assets/ultrason/green-wave-04.png", "qrc:/assets/ultrason/green-wave-05.png"];
